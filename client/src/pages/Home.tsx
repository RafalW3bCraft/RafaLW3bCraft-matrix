...
=======
                <span className="font-cyber text-xl font-bold text-neon-cyan">
                  RafalW3bCraft
                </span>
              </div>
              <p className="text-gray-400 font-mono text-sm">
                Forging Future-Ready Cyber Solutions. Secure. Smart. Excellance.
                <br />
                Cyber Engineering • App Innovation • Full-Stack Development • Automation • AI/ML • Bots
>>>>>>> b0a6a12 (intiate personal portfolio site and more)
              </p>
            </div>
            <div>
...
=======
                <a
                  href="#home"
                  className="block text-gray-400 hover:text-neon-cyan transition-colors duration-300 font-mono text-sm"
                >
                  Home
                </a>
                <a
            ...
            <div>
              <h4 className="font-cyber text-neon-green mb-4">
                Security Protocols
              </h4>
>>>>>>> b0a6a12 (intiate personal portfolio site and more)
